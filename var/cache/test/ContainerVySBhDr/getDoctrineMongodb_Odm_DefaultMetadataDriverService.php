...
class getDoctrineMongodb_Odm_DefaultMetadataDriverService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->addDriver(($container->privates['doctrine_mongodb.odm.default_attribute_metadata_driver'] ??= new \Doctrine\ODM\MongoDB\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Document')])), 'App\\Document');
